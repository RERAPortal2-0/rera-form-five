...
public class SmsContents {
	 ...
	 * sms.setMobileNo(model.getPromoterMobileNo());
	 * sms.setProcessName(ReraConstants.PROJECT_USER); StringBuilder sb=new
	 * StringBuilder(); sb.append("Dear ").append(model.getPromoterName()).
